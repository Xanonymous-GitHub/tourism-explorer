    ...
    return (
        <div className="relative bg-white overflow-hidden h-screen">
                    ...
                    <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div className="sm:text-center lg:text-left">
                            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                <span className="block xl:inline select-none">Find a place to </span>
                                <span className="block text-indigo-600 xl:inline select-none">travel</span>
                            </h1>
                            ...
                            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                <div className="rounded-md shadow">
                                    <a href="/ScenicSpot" rel='noreferrer noopener'
                                       className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
                                        Get started
                                    </a>
                                </div>
                                <div className="mt-3 sm:mt-0 sm:ml-3">
                                    <a href="https://github.com/Xanonymous-GitHub/tourism-explorer" rel='noreferrer noopener' target="_blank"
            ...
            <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img className="h-screen w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
